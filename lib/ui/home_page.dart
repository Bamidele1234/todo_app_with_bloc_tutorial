...
import 'package:todo_app_with_bloc_tutorial/bloc/todo_bloc.dart';
import 'package:todo_app_with_bloc_tutorial/model/todo.dart';

class HomePage extends StatelessWidget {
  HomePage({Key? key, required this.title}) : super(key: key);

  //We load our T0do BLoC that is used to get
  //the stream of T0do for StreamBuilder
  final TodoBloc todoBloc = TodoBloc();
  final String title;

  //Allows T0do card to be dismissible horizontally
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  if (newTodo.description!.isNotEmpty) {
                                    /*Create new T0do object and make sure
                                    the T0do description is not empty,
  ...
  Widget getTodoCardWidget(AsyncSnapshot<List<Todo>> snapshot) {
    ...
    if (snapshot.hasData) {
      ...
      but returned returned 0 records of T0do from DB.
      ...
      */
      return snapshot.data!.isNotEmpty
              ...
              itemBuilder: (context, itemPosition) {
                ...
                final Widget dismissibleCard = Dismissible(
                  ...
                  onDismissed: (direction) {
                    /*The magic
                    delete T0do item by ID whenever
                    the card is dismissed
                    */
                    todoBloc.deleteTodoById(todo.id!.toInt());
                  },
                    ...
                    child: ListTile(
                      leading: InkWell(
                        onTap: () {
                          ...
                          /*
                            Another magic.
                            This will update T0do isDone with either
                            completed or not
                          */
          ...
          : Center(
              //this is used whenever there 0 T0do
              //in the data base
